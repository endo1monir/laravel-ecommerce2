                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" wire:click="EditBrand({{$brand->id}})"
                                           data-bs-target="#EditBrandModal" data-bs-toggle="modal"
                                           class="btn btn-success text-white">Edit</a>
                                        <a wire:click="deleteBrand({{$brand->id}})" data-bs-target="#deleteBrandModal" data-bs-toggle="modal" class="btn btn-danger text-white">Delete</a>
                                    </td>
                                    </td>
                                </tr>
                            @endforeach
